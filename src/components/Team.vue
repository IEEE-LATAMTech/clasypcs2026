...
const teamList: TeamProps[] = [
  {
    imageUrl: "/imagenesTeam/Cristobal.JPG",
    firstName: "Cristóbal",
    lastName: "Arroyo",
    positions: ["Event Chair"],
    socialNetworks: [],
  },
  {
    imageUrl: "/imagenesTeam/Joseph_Rojas.jpeg",
    firstName: "Joseph",
    lastName: "Rojas",
  ...
  {
    imageUrl: "/imagenesTeam/Paula_Londoño.jpeg",
    firstName: "Paula",
    lastName: "Londoño",
  ...
  {
    imageUrl: "/imagenesTeam/Pedro.png",
    firstName: "Pedro",
    lastName: "Yannoulas",
    positions: ["Financial Committee"],
    socialNetworks: [],
  },
  {
    imageUrl: "/imagenesTeam/Cinthya_Ramon.jpg",
    firstName: "Cinthya",
    lastName: "Ramon",
    positions: ["Financial Committee"],
    socialNetworks: [],
  ...
  {
    imageUrl: "/imagenesTeam/ale.jpeg",
    firstName: "Alejandra",
    lastName: "Ponce",
    positions: ["Marketing Committee"],
    socialNetworks: [
      {
        name: "LinkedIn",
  ...
  {
    imageUrl: "/imagenesTeam/Michel.png",
    firstName: "Michel",
    lastName: "Adelino",
    positions: ["Program Committee"],
    socialNetworks: [
      {
        name: "LinkedIn",
  ...
  {
    imageUrl: "/imagenesTeam/Amanda_Calderon.jpg",
    firstName: "Amanda",
    lastName: "Calderón",
    positions: ["Marketing & Local Committee"],
    socialNetworks: [],
  },
  {
    imageUrl: "/imagenesTeam/Natasha_Urdaneta.png",
    firstName: "Natasha",
    lastName: "Urdaneta",
    positions: ["Program Committee"],
    socialNetworks: [],
  ...
  >
    <div class="text-center mb-4">
      ...
      <h2 class="text-3xl md:text-4xl text-center font-bold">
        The CLASYPCS 2026 Team
      </h2>
    </div>

    <div 
    class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 justify-items-center"
    >
      <Card
        v-for="{
          imageUrl,
